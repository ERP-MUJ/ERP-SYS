...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      {/* Video Section */}
      <div className="md:w-2.2/3 relative w-full bg-black">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white">
          <div className="rounded-lg bg-black/40 p-6 backdrop-blur-sm">
            <Image
              ...
              width={75}
              height={75}
              className="bg-white-rounded-full mx-auto mb-4"
            />
            <h1 className="mb-2 text-center text-3xl font-bold">Manipal University Jaipur</h1>
            <p className="max-w-md text-center">
              Welcome to the official portal. Please login with your credentials.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center bg-gray-50 p-8 md:w-1/2">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-center text-2xl">Login Portal</CardTitle>
                ...
                <form className="mt-4 space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <UserIcon className="text-muted-foreground absolute left-3 top-3 h-4 w-4" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <LockIcon className="text-muted-foreground absolute left-3 top-3 h-4 w-4" />
                      <Input
                        id="qoac-password"
                        type="password"
              ...
              <TabsContent value="hod">
                <form className="mt-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <BookIcon className="text-muted-foreground absolute left-3 top-3 h-4 w-4" />
                      <Input
                        id="department"
