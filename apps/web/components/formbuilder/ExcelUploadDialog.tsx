...
import { useUploadExcel } from "@/queries/excel";
...
export function ExcelUploadDialog({ kpiId, trigger }: ExcelUploadDialogProps) {
  ...
  const getStatusColor = () => {
    if (isUploading) return "bg-gray-100 text-gray-700";
