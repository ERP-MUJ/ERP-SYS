      ...
      <div className="mb-6">
        <div className="space-y-6">
          <div className="flex flex-col">
            <Label className="mb-2 text-lg font-medium">KPI</Label>
          ...
          {/* KPI Value Input */}
          <div className="flex flex-col">
            <Label className="mb-2 text-lg font-medium">Value</Label>
            <p className="mb-2 text-sm text-gray-500">Value of each KPI in a specific metric.</p>
            <Input
              id="form-value"
          ...
          <div>
            <div className="flex flex-col">
              <Label className="mb-2 text-lg font-medium">Upload KPI Template</Label>
              <p className="mb-2 text-sm text-gray-500">
                Upload an Excel template for this KPI. This will help faculty understand the
                expected format.
              </p>
              <Input
                id="template-upload"
