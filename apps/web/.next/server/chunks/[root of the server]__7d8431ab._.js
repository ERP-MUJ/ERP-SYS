...
"[project]/apps/web/.next-internal/server/app/api/kpi/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/api/kpi/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        // Check if KPI exists
        const existingKpi = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].kpi.findUnique({
            where: {
                kpi_id
            }
        });
        ...
        const updatedKpi = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].kpi.update({
            where: {
                kpi_id
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const deletedAssignments = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].assigned_kpi.deleteMany({
            where: {
                kpi_name: existingKpi.kpi_name
            }
        });
        // Then delete the KPI itself
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].kpi.delete({
            where: {
                kpi_id
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7d8431ab._.js.map