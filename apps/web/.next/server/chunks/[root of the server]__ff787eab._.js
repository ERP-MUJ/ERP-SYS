...
"[project]/apps/web/.next-internal/server/app/api/department/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/api/department/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/packages/db/src/index.ts [app-route] (ecmascript) <module evaluation>"); // Make sure this points to your Prisma client
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/db/src/client.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    try {
        const departments = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].departments.findMany({
            include: {
                pillars: {
                    select: {
                        pillar_id: true,
...
async function POST(request) {
    try {
        ...
        const existingDepartment = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].departments.findUnique({
            where: {
                dept_name
            }
        });
        ...
        const newDepartment = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].departments.create({
            data: {
                dept_name,
                hod_id: hod_id || null,
...
async function PUT(request) {
    try {
        ...
        // Update department
        const updatedDepartment = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].departments.update({
            where: {
                dept_id: Number(dept_id)
            },
            data: updateData
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].departments.delete({
            where: {
                dept_id: Number(dept_id)
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ff787eab._.js.map