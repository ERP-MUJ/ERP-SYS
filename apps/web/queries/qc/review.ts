...
import { QcReviewService, UpdateKpiStatusPayload } from "@/services/qc/review.service";
...
export function useUpdateKpiStatus() {
  ...
  return useMutation({
    mutationFn: async ({ kpiId, payload }: { kpiId: string; payload: UpdateKpiStatusPayload }) => {
